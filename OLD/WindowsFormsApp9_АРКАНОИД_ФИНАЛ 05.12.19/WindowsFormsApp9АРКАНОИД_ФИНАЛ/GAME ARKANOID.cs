...
namespace WindowsFormsApp9АРКАНОИД_ФИНАЛ
{
    public partial class Form2 : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            this.Text = "Имя " + dataGridView1[0, 0].Value.ToString() +  ", Счет " + score;
        }
        void GameOver()
            {
            timer1.Stop();
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            ...
            label2.Text = "Имя игрока "+dataGridView1[0, 0].Value.ToString();
            conn.Close();
            player.Text = dataGridView1[0, 0].Value.ToString();
        }
